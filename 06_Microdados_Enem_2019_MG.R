...
enem_mg_2019 <- ENEM_2019 %>% filter(SG_UF_RESIDENCIA =="MG")

# Selecionando as colunas de interesse
enem_mg_2019 <- select(enem_mg_2019, NU_INSCRICAO, NU_ANO, NO_MUNICIPIO_RESIDENCIA,
...
#EXPORTAR ARQUIVO
write.table(enem_mg_2019, file ="enem_mg_2019.csv", sep = ",")